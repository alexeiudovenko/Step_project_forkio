$(document).ready(function(e) {
    $(".hamburger-menu").on("click", function(e) {
        if ($(this).attr("data-clicked") == 0) {
            ...
            $(".hamburger-menu__bars").eq(0).css({
                transform: "rotate(45deg) translate(3px, 10px)",
                width: "27px",
            });
            $(".hamburger-menu__bars")
                .eq(2)
                .css({ transform: "rotate(-45deg) translate(2px, -10px)" });
            ...
            $(".hamburger-menu__bars")
                .eq(0)
                .css({ transform: "rotate(0) translate(0, 0)", width: "21px" });
            $(".hamburger-menu__bars")
                .eq(2)
                .css({ transform: "rotate(0) translate(0, 0 )" });
